		...
		<header className="flex flex-col gap-[15px] relative overflow-hidden">
			{
				...
				<div className="flex items-center justify-between h-full px-[25px] lg:w-[95%] lg:mx-auto lg:px-0">
				<div className="flex items-center gap-[20px]">
					...
					<p className="text-[#141415] font-[500] text-[14px] cursor-pointer">Пункты выдачи</p>
				</div>
				<p className="text-[#62656a] text-[14px] text-center hidden leading-3 lg:block">Доставим ваш заказ бесплатно — всего за 1 день!</p>
				<div className="flex items-center gap-[20px]">
				<p className="text-[#62656a] font-[500] text-[14px] cursor-pointer">Продавайте на Uzum</p>
				<p className="text-[#62656a] font-[500] text-[14px] cursor-pointer">Мои заказы</p>
				<div className="flex items-center gap-[5px] cursor-pointer">
				<img src="../../public/images/rus.png" width='24' height='24' alt="" />
				<p className="text-[#62656a] font-[500] text-[14px] cursor-pointer">Русский</p>
				</div>
				</div>
				</div>
			</div>
			...
			<div className="bg-[white] flex flex-col gap-[17px] px-[10px] md:px-[25px] lg:px-[0] lg:w-[95%] lg:mx-auto">
			...
			<div className="hidden items-center gap-[25px] h-[39px] md:flex lg:px-[0] lg:w-[95%] lg:mx-auto">
