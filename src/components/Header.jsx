		...
		<header className="flex flex-col gap-[15px] relative overflow-hidden">
			...
			<div className="bg-[white] flex flex-col gap-[17px] px-[10px] md:px-[25px] lg:px-[0] lg:w-[1240px] lg:mx-auto">
				<div className="flex items-center justify-between">
					...
					{
						likedID.length !== 0 ? <div className="text-[12px] text-[#fff] px-[4px] bg-[#7000ff]">{likedID.length + 1}</div> : null
					}
					</Link>
					...
					{
						cartData.length !== 0 ? <div className="text-[12px] text-[#fff] px-[4px] bg-[#7000ff]">{cartData.length + 1}</div> : null
					}
					</Link>
					</div>
				</div>
