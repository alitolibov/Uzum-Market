...
const CartItem = () => {
    ...
    <div className="flex flex-col gap-[10px] lg:flex-row lg:justify-between">
        <div className="flex items-center gap-[20px]">
            <div className="w-[52.5px] h-[52.5px] bg-cover md:w-[100px] md:h-[100px]" style={{backgroundImage: `url('')`}}></div>
            <div className="flex flex-col gap-[10px]">
                <p className="text-[12.25px] md:text-[16px]">tualetka</p>
        ...
        <div className="float-right w-fit flex flex-col items-end">
            ...
            <p className="text-[10.5px] text-[#757575] line-through md:text-[14px]">16 000</p>
        </div>
        </div>
        ...
        <div className="hidden items-center justify-end w-[50%] gap-[20%] lg:flex">
        <div className="flex items-center h-[35px] gap-[20px] rounded-[4px] borderFul cursor-pointer px-[10px]">
            <p className="text-[50px] leading-[0px] font-[200]" style={{color: count !== 1 ? '#000000' : "#00000050"}} onClick={decrement}>-</p>
            <p className="text-[14px] mx-auto">{count}</p>
            <p className="text-[23px] font-[300]" onClick={increment}>+</p>
        ...
        <p className="text-[#757575] md:text-[12px]">Удалить</p>
            ...
            <p className="font-[500] text-[20px]">13 000<span> руб</span></p>
            <p className="text-[#757575] line-through md:text-[14px]">16 000</p>
        </div>
        </div>
        </div>
    </div>
