...
import { deleteLiked, postLiked } from "../features/liked/thunk";
...
const Item = ({item}) => {
    ...
    <div className="rounded-[8px] cursor-pointer hoverBlock overflow-hidden duration-[250ms] min-w-[140px] h-fit">
        <div className="relative duration-[250ms] overflow-hidden bg-[#fff] mb-[10px]">
            {
                likedID.includes(item.id) ? <svg onClick={() => dispatch(deleteLiked(item.id))} className="w-fit float-right" data-v-b3e9397c="" width="20" height="20" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg" alt="like">
                ...
                </svg> : <svg onClick={() => dispatch(postLiked(item))} className="w-fit float-right top-[5px] right-[5px]" data-v-b3e9397c="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
