...
const Footer = () => {
    return ( 
        <footer className="flex flex-col gap-[30px] px-[32px] py-[25px] w-full lg:w-[1240px] lg:px-[0] lg:mx-auto">
