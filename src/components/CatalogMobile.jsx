...
const CatalogMobile = ({open, changeOpen}) => {
    return ( 
        <div className="absolute top-0 w-full h-[100vh] overflow-y-hidden bg-[#EFEFEF] flex-col gap-[7px]" style={{display: open ? 'flex' : 'none'}}>
            ...
            <div className="pl-[15px] bg-white">
                ...
                <p className="text-[13px]">Город: Самарканд</p>
                </div>
